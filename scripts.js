window.writeValues = function(form) {
  ...
  if(photo.value = "zespol"){
    document.forms[0].elements[6].options[3].value='<a href="https://www.karierawunum.pl">' + '<img src="https://www.unum.pl/wp-content/uploads/2022/04/Banner_Dolacz_krotki_500x100px.png" style="width: 500px;">' + '</a>';
  } 
